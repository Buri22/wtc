...
export default class Counter {
    ...
    // Bind Events
    bindCounterEvents() {
        this.$newItemBtn.off('click').on('click', this._renderModal);
        this.$itemList.find('li').on('click', this._renderModal);
        this.$itemList.find('li .start').on('click', this._startTicking);
        ...
        this.$pagination.find('li a').off('click').on('click', this._changeTablePage);
        this.$paginationItemsPerPage.off('change').on('change', this._changeNumOfItemsPerPage);
        this.$menuItem.off('click').on('click', this.renderCounter);
    }
